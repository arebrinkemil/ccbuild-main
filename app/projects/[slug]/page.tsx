...
const Page: FC<PageProps> = async ({ params }) => {
  ...
  try {
    const res = await fetch(
      `https://ccbuild-main.vercel.app/api/projects/${params.slug}`,
      {
        cache: "no-store",
      }
    );
  ...
  try {
    const resProducts = await fetch(
      `https://ccbuild-main.vercel.app/api/products/${project._id}`,
      {
        cache: "no-store",
      }
    );
  ...
  return (
    <>
      ...
      <Link
        href={`https://ccbuild-main.vercel.app/projects/${params.slug}/product/create`}
      >
